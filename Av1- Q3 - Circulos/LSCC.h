...
/* Recebe duas listas (l1 e l2) e remove a sublista l2 de l1, caso l2 possua a mesma sequência de nós em l1. A função percorre l1 e l2 simultaneamente, verificando se os nós coincidem. Se a sequência de nós de l2 for encontrada em l1, ela é removida de l1 */
